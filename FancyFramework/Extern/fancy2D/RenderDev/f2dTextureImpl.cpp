...
f2dTexture2DStatic::f2dTexture2DStatic(f2dRenderDevice* pDev, fByte* pData, fLen Len, fuInt Width, fuInt Height, fBool HasMipmap)
    : m_Width(Width), m_Height(Height), m_pTex(NULL)
{
    if (!pData)
        throw fcyException("f2dTexture2DStatic::f2dTexture2DStatic", "Param 'tData' is null.");
...
f2dTexture2DDynamic::f2dTexture2DDynamic(f2dRenderDevice* pDev, fByte* pData, fLen Len, fuInt Width, fuInt Height)
    : m_pParent(pDev), m_Width(Width), m_Height(Height), m_pTex(NULL)
{
    if (!pData)
        throw fcyException("f2dTexture2DDynamic::f2dTexture2DDynamic", "Param 'tData' is null.");
