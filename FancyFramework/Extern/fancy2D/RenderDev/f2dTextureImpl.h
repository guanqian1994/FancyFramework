...
protected:
    ...
    f2dTexture2DStatic(f2dRenderDevice* pDev, fByte* pData, fLen Len, fuInt Width, fuInt Height, fBool HasMipmap);
	~f2dTexture2DStatic();
};
...
protected:
    ...
    f2dTexture2DDynamic(f2dRenderDevice* pDev, fByte* pData, fLen Len, fuInt Width, fuInt Height);
	~f2dTexture2DDynamic();
};
